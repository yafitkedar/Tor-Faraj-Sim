...
def run_simulations_sleep():
	...
	#fin.close()
    fin = open('conf_sleep_end.fds.txt', 'r')
...
def run_simulations_middle():
    sim_tests = [("350"), ("215"), ("340"), ("330"), ("220"), ("320"), ("225"), ("310"), ("230"), ("300"), ("235"), ("290"), ("280"), ("270"), ("260"), 
                 ("240"), ("245"), ("250"), ("255"), ("265"), ("275"), ("285"), ("295"),
